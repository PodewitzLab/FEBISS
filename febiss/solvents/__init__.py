...
SOLVENT_DICT = {
    #Format: Solvent name: (Abbreviation, Solvent file, Rigid Atoms, Reference Density, Reference Eww)
    ...
    'Dichloro methane': ('DCM', 'DCM.mol2', (1, 0, 2), 0.009, -6.02),
    ...
    # "n-Octanol (OCT)",
    'Pyridine': ('PYR', 'PYR.mol2', (1, 0, 8), 0.0075, None),
    'Tetrahydrofuran': ('THF', 'THF.mol2', (3, 8, 5), 0.0074, None),
    'Toluene': ('TOL', 'TOL.mol2', (5, 6, 8), 0.0055, None),
