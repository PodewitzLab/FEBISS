# source:
# https://github.com/christophhagen/averaging-quaternions/blob/8e75707891d2ad2f1bdecc5dc7b9bdb81fa7935f/averageQuaternions.py
#
# Changes to source:
#   7 Nov 2023:
#   -import numpy as np and change "numpy..." to "np..."
#   -change npm to np since npm is deprecated. npm was only used for the all-zeroes matrix.
#   -removed "A1" at the end of return command since this is not defined for arrays
